...
<div id="content">
    <form id="cusotmer_edit_form" class="css-form">
        ...
        <div class="css-form-row">
            ...
            <input type="text" id="customer_name" name="customerName" value="${user.username}" class="ext-required"/>
            <span class="css-color-red">*</span>
        </div>
        <div class="css-form-row">
            <label for="description">Description:</label>
            <textarea id="description" name="description" rows="5">${user.username}</textarea>
        </div>
